...
troshx_tros_ai_TROSAiBot.getComboAction = function(combo,cp,cp2,threatManuever,hasInitiative,secondExchange) {
	...
	case -1:
		if(threatManuever != null) {
			...
			} else return troshx_tros_ai_TROSAiBot.getSpecialDefWithReturnAttack(cp,cp2,threatManuever.manueverCP,threatManuever.manueverTN,0,true) || troshx_tros_ai_TROSAiBot.getFBDefense(true,cp,threatManuever.manueverCP,threatManuever.manueverTN,true,2) || troshx_tros_ai_TROSAiBot.getFleeOrDefend(false,cp,cp2,threatManuever.manueverTN,true,2,0,true);
		}
		break;
	case -2:
		if(threatManuever != null) {
...
troshx_tros_ai_TROSAiBot.tryBestPossibleDefenseRemaining = function(cp,cp2,threatManuever) {

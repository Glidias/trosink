...
troshx_tros_ai_TROSAiBot.getComboAction = function(combo,cp,cp2,threatManuever,hasInitiative,secondExchange) {
	...
	case 1:
		return troshx_tros_ai_TROSAiBot.getFavorableAttack(cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),true,flags,null) || troshx_tros_ai_TROSAiBot.getAdvantageGainCPOffensiveMove(true,cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),flags) || troshx_tros_ai_TROSAiBot.getBorderlineAttack(cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),true,flags) || troshx_tros_ai_TROSAiBot.getAdvantageGainCPOffensiveMove(false,cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),flags);
	case 2:
		if(!secondExchange) return troshx_tros_ai_TROSAiBot.getAForcefulInitiativeAttack(troshx_tros_ai_TROSAiBot.P_THRESHOLD_FAVORABLE,cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),true,true,0); else return troshx_tros_ai_TROSAiBot.getFavorableAttack(cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),true,flags,null) || troshx_tros_ai_TROSAiBot.getAdvantageGainCPOffensiveMove(true,cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),flags) || troshx_tros_ai_TROSAiBot.getBorderlineAttack(cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),true,flags) || troshx_tros_ai_TROSAiBot.getAdvantageGainCPOffensiveMove(false,cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),flags);
		break;
	case 3:
		if(!secondExchange) {
		} else return troshx_tros_ai_TROSAiBot.getFavorableAttack(cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),true,flags,null) || troshx_tros_ai_TROSAiBot.getBorderlineAttack(cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),true,flags);
		break;
	case 4:
		if(!secondExchange) {
		} else return troshx_tros_ai_TROSAiBot.getFavorableAttack(cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),true,flags,null) || troshx_tros_ai_TROSAiBot.getBorderlineAttack(cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),true,flags);
	...
	case 9:
		...
		troshx_tros_ai_TROSAiBot.B_BS_REQUIRED_DMG_DEFAULT += 1;
		result = cp2 < troshx_tros_ai_TROSAiBot.ENEMY_STEAL_COST + 1 + troshx_tros_ai_TROSAiBot.MIN_EXPOSED_AV && troshx_tros_ai_TROSAiBot.getFavorableAttack(cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),true,flags,cp2 >= 2?0:cp2 == 0?0.00001:0.5);
		troshx_tros_ai_TROSAiBot.B_BS_REQUIRED_DMG_DEFAULT = lastInt;
		return result;
	case -1:
		return troshx_tros_ai_TROSAiBot.getFavorableAttack(cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),true,flags,null) || troshx_tros_ai_TROSAiBot.getBorderlineAttack(cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),true,flags);
	case -3:
		return troshx_tros_ai_TROSAiBot.getFavorableAttack(cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),true,flags,null) || troshx_tros_ai_TROSAiBot.getBorderlineAttack(cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),true,flags);
	case -4:
		return troshx_tros_ai_TROSAiBot.getFavorableAttack(cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),true,flags,null) || troshx_tros_ai_TROSAiBot.getBorderlineAttack(cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),true,flags);

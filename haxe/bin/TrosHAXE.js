	...
	if(!secondExchange) {
		...
		if(minCPRequired > 0) {
			...
			if(isDamaging?troshx_tros_ai_TROSAiBot.getFBDefense(false,cpLeft,threatManuever.manueverCP,threatManuever.manueverTN,true,6,0.0001):troshx_tros_ai_TROSAiBot.getFBDefense(false,cpLeft,threatManuever.manueverCP,threatManuever.manueverTN,true,2,0)) {
				...
				if(cpRight == 0) cpRight = troshx_tros_ai_TROSAiBot.checkCostViabilityWithBs(availableCP,4,troshx_tros_ai_TROSAiBot.P_THRESHOLD_BORDERLINE,enemyCPInReserve,opponentATN,false,1);
				if(cpRight > 0) {
				...
				return true;
			} else return troshx_tros_ai_TROSAiBot.getFleeOrDefend(false,cpLeft,threatManuever.manueverCP,threatManuever.manueverTN,true,2,0.00000001,secondExchange);
		}
		return troshx_tros_ai_TROSAiBot.getDesperateFlee(availableCP,secondExchange) || troshx_tros_ai_TROSAiBot.getFleeOrDefend(false,availableCP,threatManuever.manueverCP,threatManuever.manueverTN,true,2,0.00000001,secondExchange);
	}
...
troshx_tros_ai_TROSAiBot.prototype = {
	...
	,getRemainingCPLeftIfUnpaid: function() {
		...
		while(_g1 < _g) {
			var i = _g1++;
			cpLeft -= this.decidedManuevers[i].getManueverCPSpent();
		}
		return cpLeft;
	}
	,getTotalThreatCPAgainst: function(targetId) {
		var cpAccum;
		if(troshx_tros_ai_TROSAiBot.CP_ALREADY_PAID) cpAccum = this.cp; else cpAccum = this.getRemainingCPLeftIfUnpaid();
		var choice;
		choice = this.decidedManuevers[0];
		if(choice.againstID == targetId) cpAccum += choice.cost + choice.manueverCP;
	...
	,declareManueverAgainstOpponent: function(index) {
		...
		if(this.get_initiative()) return troshx_tros_ai_TROSAiBot.tryBestPossibleAttackOrDefBoliao(this.cp,opponentCP,threatManuever,this.currentExchange == 2); else return troshx_tros_ai_TROSAiBot.tryBestPossibleDefenseBoliao(this.cp,opponentCP,threatManuever,this.currentExchange == 2);
		return false;
	}
	...
	,set_initiative: function(value) {
		return (value?this.fight_initiative = 1:this.fight_initiative = 0) != 0;
	}
...
troshx_tros_ai_TROSAiBotInkle.bindWatchesForInk = function(c,toStory,requireMeta) {
	if(requireMeta == null) requireMeta = "watch";
...
troshx_util_ReflectUtil.setItemFieldsTo = function(c,to,isStatic,requireMeta,reference) {
	if(isStatic == null) isStatic = false;
	var rtti = haxe_rtti_Rtti.getRtti(c);
	if(reference == null) if(isStatic) reference = c; else reference = Type.createEmptyInstance(c);
	var meta;
	if(isStatic) meta = haxe_rtti_Meta.getStatics(c); else meta = haxe_rtti_Meta.getFields(c);
	var _g_head;
	_g_head = (isStatic?rtti.statics:rtti.fields).h;
...
troshx_tros_ai_TROSAiBot.__rtti = "<class path=\"troshx.tros.ai.TROSAiBot\" params=\"\">\n\t<ENEMY_STEAL_COST expr=\"4\" line=\"44\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>4</e></m></meta>\n\t</ENEMY_STEAL_COST>\n\t<MIN_EXPOSED_AV expr=\"0\" line=\"45\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>0</e></m></meta>\n\t</MIN_EXPOSED_AV>\n\t<getTargetAlphaStrikeCPThreshold get=\"inline\" set=\"null\" line=\"46\" static=\"1\"><f a=\"\"><x path=\"Int\"/></f></getTargetAlphaStrikeCPThreshold>\n\t<setAlphaStrikeBudget get=\"inline\" set=\"null\" line=\"49\" static=\"1\"><f a=\"cp:cp2\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n\t<x path=\"Void\"/>\n</f></setAlphaStrikeBudget>\n\t<AVAIL_bash public=\"1\" expr=\"0\" line=\"77\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0</e></m>\n\t\t\t<m n=\"inspect\"><e>{min:0}</e></m>\n\t\t\t<m n=\"watch\"/>\n\t\t</meta>\n\t</AVAIL_bash>\n\t<AVAIL_spike public=\"1\" expr=\"0\" line=\"78\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0</e></m>\n\t\t\t<m n=\"inspect\"><e>{min:0}</e></m>\n\t\t\t<m n=\"watch\"/>\n\t\t</meta>\n\t</AVAIL_spike>\n\t<AVAIL_cut public=\"1\" expr=\"0\" line=\"79\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0</e></m>\n\t\t\t<m n=\"inspect\"><e>{min:0}</e></m>\n\t\t\t<m n=\"watch\"/>\n\t\t</meta>\n\t</AVAIL_cut>\n\t<AVAIL_thrust public=\"1\" expr=\"0\" line=\"80\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0</e></m>\n\t\t\t<m n=\"inspect\"><e>{min:0}</e></m>\n\t\t\t<m n=\"watch\"/>\n\t\t</meta>\n\t</AVAIL_thrust>\n\t<AVAIL_beat public=\"1\" expr=\"0\" line=\"81\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0</e></m>\n\t\t\t<m n=\"inspect\"><e>{min:0}</e></m>\n\t\t\t<m n=\"watch\"/>\n\t\t</meta>\n\t</AVAIL_beat>\n\t<AVAIL_bindstrike public=\"1\" expr=\"0\" line=\"82\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0</e></m>\n\t\t\t<m n=\"inspect\"><e>{min:0}</e></m>\n\t\t\t<m n=\"watch\"/>\n\t\t</meta>\n\t</AVAIL_bindstrike>\n\t<AVAIL_hook public=\"1\" expr=\"0\" line=\"83\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0</e></m>\n\t\t\t<m n=\"inspect\"><e>{min:0}</e></m>\n\t\t\t<m n=\"watch\"/>\n\t\t</meta>\n\t</AVAIL_hook>\n\t<AVAIL_block public=\"1\" expr=\"0\" line=\"86\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0</e></m>\n\t\t\t<m n=\"inspect\"><e>{min:0}</e></m>\n\t\t\t<m n=\"watch\"/>\n\t\t</meta>\n\t</AVAIL_block>\n\t<AVAIL_parry public=\"1\" expr=\"0\" line=\"87\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0</e></m>\n\t\t\t<m n=\"inspect\"><e>{min:0}</e></m>\n\t\t\t<m n=\"watch\"/>\n\t\t</meta>\n\t</AVAIL_parry>\n\t<AVAIL_duckweave public=\"1\" expr=\"0\" line=\"88\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0</e></m>\n\t\t\t<m n=\"inspect\"><e>{min:0}</e></m>\n\t\t\t<m n=\"watch\"/>\n\t\t</meta>\n\t</AVAIL_duckweave>\n\t<AVAIL_partialevasion public=\"1\" expr=\"0\" line=\"89\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0</e></m>\n\t\t\t<m n=\"inspect\"><e>{min:0}</e></m>\n\t\t\t<m n=\"watch\"/>\n\t\t</meta>\n\t</AVAIL_partialevasion>\n\t<AVAIL_fullevasion public=\"1\" expr=\"0\" line=\"90\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0</e></m>\n\t\t\t<m n=\"inspect\"><e>{min:0}</e></m>\n\t\t\t<m n=\"watch\"/>\n\t\t</meta>\n\t</AVAIL_fullevasion>\n\t<AVAIL_blockopenstrike public=\"1\" expr=\"0\" line=\"91\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0</e></m>\n\t\t\t<m n=\"inspect\"><e>{min:0}</e></m>\n\t\t\t<m n=\"watch\"/>\n\t\t</meta>\n\t</AVAIL_blockopenstrike>\n\t<AVAIL_counter public=\"1\" expr=\"0\" line=\"92\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0</e></m>\n\t\t\t<m n=\"inspect\"><e>{min:0}</e></m>\n\t\t\t<m n=\"watch\"/>\n\t\t</meta>\n\t</AVAIL_counter>\n\t<AVAIL_rota public=\"1\" expr=\"0\" line=\"93\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0</e></m>\n\t\t\t<m n=\"inspect\"><e>{min:0}</e></m>\n\t\t\t<m n=\"watch\"/>\n\t\t</meta>\n\t</AVAIL_rota>\n\t<AVAIL_expulsion public=\"1\" expr=\"0\" line=\"94\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0</e></m>\n\t\t\t<m n=\"inspect\"><e>{min:0}</e></m>\n\t\t\t<m n=\"watch\"/>\n\t\t</meta>\n\t</AVAIL_expulsion>\n\t<AVAIL_disarm public=\"1\" expr=\"0\" line=\"95\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0</e></m>\n\t\t\t<m n=\"inspect\"><e>{min:0}</e></m>\n\t\t\t<m n=\"watch\"/>\n\t\t</meta>\n\t</AVAIL_disarm>\n\t<AVAIL_StealInitiative public=\"1\" expr=\"0\" line=\"96\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0</e></m>\n\t\t\t<m n=\"inspect\"><e>{min:0}</e></m>\n\t\t\t<m n=\"watch\"/>\n\t\t</meta>\n\t</AVAIL_StealInitiative>\n\t<setTypicalAVAILCostsForTesting set=\"method\" line=\"98\" static=\"1\"><f a=\"\"><x path=\"Void\"/></f></setTypicalAVAILCostsForTesting>\n\t<getCostOfAVAIL get=\"inline\" set=\"null\" line=\"120\" static=\"1\"><f a=\"avail\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></getCostOfAVAIL>\n\t<getCostOfManuever set=\"method\" line=\"124\" static=\"1\"><f a=\"manuever\">\n\t<c path=\"String\"/>\n\t<x path=\"Int\"/>\n</f></getCostOfManuever>\n\t<B_EQUIP expr=\"&quot;&quot;\" line=\"154\" static=\"1\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>\"\"</e></m>\n\t\t\t<m n=\"settable\"/>\n\t\t</meta>\n\t</B_EQUIP>\n\t<B_IS_OFFHAND expr=\"false\" line=\"155\" static=\"1\">\n\t\t<x path=\"Bool\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>false</e></m>\n\t\t\t<m n=\"settable\"/>\n\t\t</meta>\n\t</B_IS_OFFHAND>\n\t<D_EQUIP expr=\"&quot;&quot;\" line=\"156\" static=\"1\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>\"\"</e></m>\n\t\t\t<m n=\"settable\"/>\n\t\t</meta>\n\t</D_EQUIP>\n\t<B_COMBO_EXCHANGE_BUDGET expr=\"&apos;???&apos;\" line=\"159\" static=\"1\">\n\t\t<x path=\"haxe.ds.Vector\"><x path=\"Int\"/></x>\n\t\t<meta><m n=\":value\"><e>'???'</e></m></meta>\n\t</B_COMBO_EXCHANGE_BUDGET>\n\t<BUDGET_EXCHANGE_1 get=\"inline\" set=\"null\" expr=\"0\" line=\"160\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>0</e></m></meta>\n\t</BUDGET_EXCHANGE_1>\n\t<BUDGET_EXCHANGE_1_ENEMY get=\"inline\" set=\"null\" expr=\"1\" line=\"161\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>1</e></m></meta>\n\t</BUDGET_EXCHANGE_1_ENEMY>\n\t<BUDGET_EXCHANGE_2 get=\"inline\" set=\"null\" expr=\"2\" line=\"162\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>2</e></m></meta>\n\t</BUDGET_EXCHANGE_2>\n\t<BUDGET_EXCHANGE_2_ENEMY get=\"inline\" set=\"null\" expr=\"3\" line=\"163\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>3</e></m></meta>\n\t</BUDGET_EXCHANGE_2_ENEMY>\n\t<WISH_TO_REGAIN_STANCE expr=\"false\" line=\"165\" static=\"1\">\n\t\t<x path=\"Bool\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>false</e></m>\n\t\t\t<m n=\"inspect\"/>\n\t\t</meta>\n\t</WISH_TO_REGAIN_STANCE>\n\t<CURRENTLY_AGGROED expr=\"false\" line=\"166\" static=\"1\">\n\t\t<x path=\"Bool\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>false</e></m>\n\t\t\t<m n=\"inspect\"/>\n\t\t</meta>\n\t</CURRENTLY_AGGROED>\n\t<CURRENT_OPPONENT static=\"1\">\n\t\t<c path=\"troshx.tros.ai.TROSAiBot\"/>\n\t\t<meta><m n=\"inject\"/></meta>\n\t</CURRENT_OPPONENT>\n\t<CP_ALREADY_PAID public=\"1\" expr=\"true\" line=\"170\" static=\"1\">\n\t\t<x path=\"Bool\"/>\n\t\t<meta><m n=\":value\"><e>true</e></m></meta>\n\t</CP_ALREADY_PAID>\n\t<COMBO_PureMeanStrikes get=\"inline\" set=\"null\" expr=\"1\" line=\"175\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>1</e></m></meta>\n\t</COMBO_PureMeanStrikes>\n\t<COMBO_HeavyFirstStrikes get=\"inline\" set=\"null\" expr=\"2\" line=\"176\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>2</e></m></meta>\n\t</COMBO_HeavyFirstStrikes>\n\t<COMBO_AlphaDisarm get=\"inline\" set=\"null\" expr=\"3\" line=\"177\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>3</e></m></meta>\n\t</COMBO_AlphaDisarm>\n\t<COMBO_AlphaHookStrike get=\"inline\" set=\"null\" expr=\"4\" line=\"178\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>4</e></m></meta>\n\t</COMBO_AlphaHookStrike>\n\t<COMBO_AlphaStrike get=\"inline\" set=\"null\" expr=\"5\" line=\"179\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>5</e></m></meta>\n\t</COMBO_AlphaStrike>\n\t<COMBO_FeintStrike get=\"inline\" set=\"null\" expr=\"6\" line=\"180\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>6</e></m></meta>\n\t</COMBO_FeintStrike>\n\t<COMBO_DoubleAttack get=\"inline\" set=\"null\" expr=\"7\" line=\"181\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>7</e></m></meta>\n\t</COMBO_DoubleAttack>\n\t<COMBO_SimulatenousBlockStrike get=\"inline\" set=\"null\" expr=\"8\" line=\"182\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>8</e></m></meta>\n\t</COMBO_SimulatenousBlockStrike>\n\t<COMBOS_LEN_INITIATIVE get=\"inline\" set=\"null\" expr=\"9\" line=\"183\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>9</e></m></meta>\n\t</COMBOS_LEN_INITIATIVE>\n\t<COMBO_CoupDeGrace get=\"inline\" set=\"null\" expr=\"9\" line=\"184\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>9</e></m></meta>\n\t</COMBO_CoupDeGrace>\n\t<COMBOS_LEN_INITIATIVE_FINAL get=\"inline\" set=\"null\" expr=\"10\" line=\"185\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>10</e></m></meta>\n\t</COMBOS_LEN_INITIATIVE_FINAL>\n\t<COMBO_DefensiveFirst get=\"inline\" set=\"null\" expr=\"-1\" line=\"188\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>-1</e></m></meta>\n\t</COMBO_DefensiveFirst>\n\t<COMBO_DefensiveBorderline get=\"inline\" set=\"null\" expr=\"-2\" line=\"189\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>-2</e></m></meta>\n\t</COMBO_DefensiveBorderline>\n\t<COMBO_SpecialDefFirst get=\"inline\" set=\"null\" expr=\"-3\" line=\"190\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>-3</e></m></meta>\n\t</COMBO_SpecialDefFirst>\n\t<COMBO_AlphaInitiativeStealer get=\"inline\" set=\"null\" expr=\"-4\" line=\"191\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>-4</e></m></meta>\n\t</COMBO_AlphaInitiativeStealer>\n\t<COMBO_AlphaDisarmDef get=\"inline\" set=\"null\" expr=\"-5\" line=\"192\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>-5</e></m></meta>\n\t</COMBO_AlphaDisarmDef>\n\t<COMBO_SimulatenousBlockStrikeStealer get=\"inline\" set=\"null\" expr=\"-6\" line=\"193\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>-6</e></m></meta>\n\t</COMBO_SimulatenousBlockStrikeStealer>\n\t<COMBOS_LEN_NO_INITAITIVE get=\"inline\" set=\"null\" expr=\"7\" line=\"194\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>7</e></m></meta>\n\t</COMBOS_LEN_NO_INITAITIVE>\n\t<P_THRESHOLD_FAVORABLE public=\"1\" expr=\"0.75\" line=\"197\" static=\"1\">\n\t\t<x path=\"Float\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0.75</e></m>\n\t\t\t<m n=\"inspect\"><e>{min:0,max:1,display:\"range\",step:0.01}</e></m>\n\t\t</meta>\n\t</P_THRESHOLD_FAVORABLE>\n\t<P_THRESHOLD_BORDERLINE public=\"1\" expr=\"0.5\" line=\"198\" static=\"1\">\n\t\t<x path=\"Float\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0.5</e></m>\n\t\t\t<m n=\"inspect\"><e>{min:0,max:1,display:\"range\",step:0.01}</e></m>\n\t\t</meta>\n\t</P_THRESHOLD_BORDERLINE>\n\t<P_RECKLESS public=\"1\" expr=\"0.2\" line=\"199\" static=\"1\">\n\t\t<x path=\"Float\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0.2</e></m>\n\t\t\t<m n=\"inspect\"><e>{min:0,max:1,display:\"range\",step:0.01}</e></m>\n\t\t</meta>\n\t</P_RECKLESS>\n\t<P_THRESHOLD_ANTI_FAVORABLE public=\"1\" expr=\"0.75\" line=\"202\" static=\"1\">\n\t\t<x path=\"Float\"/>\n\t\t<meta><m n=\":value\"><e>0.75</e></m></meta>\n\t</P_THRESHOLD_ANTI_FAVORABLE>\n\t<B_CANDIDATES expr=\"[]\" line=\"206\" static=\"1\">\n\t\t<c path=\"Array\"><c path=\"String\"/></c>\n\t\t<meta><m n=\":value\"><e>[]</e></m></meta>\n\t</B_CANDIDATES>\n\t<B_CANDIDATE_COUNT expr=\"0\" line=\"207\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>0</e></m></meta>\n\t</B_CANDIDATE_COUNT>\n\t<B_BS_REQUIRED expr=\"1\" line=\"208\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>1</e></m></meta>\n\t</B_BS_REQUIRED>\n\t<B_BS_REQUIRED_DEFAULT expr=\"1\" line=\"211\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>1</e></m></meta>\n\t</B_BS_REQUIRED_DEFAULT>\n\t<COUP_BS_MODIFIER get=\"inline\" set=\"null\" expr=\"1\" line=\"212\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>1</e></m></meta>\n\t</COUP_BS_MODIFIER>\n\t<B_BS_REQUIRED_DMG_DEFAULT expr=\"1\" line=\"213\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>1</e></m>\n\t\t\t<m n=\"inspect\"><e>{min:1}</e></m>\n\t\t</meta>\n\t</B_BS_REQUIRED_DMG_DEFAULT>\n\t<PREFERED_HOOK_BS expr=\"2\" line=\"214\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>2</e></m></meta>\n\t</PREFERED_HOOK_BS>\n\t<PREFERED_DISARM_BS expr=\"2\" line=\"215\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>2</e></m></meta>\n\t</PREFERED_DISARM_BS>\n\t<PREFERED_DISARM_DEF_BS expr=\"2\" line=\"216\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>2</e></m></meta>\n\t</PREFERED_DISARM_DEF_BS>\n\t<CAN_DESPERATE_ALPHASTRIKE expr=\"false\" line=\"217\" static=\"1\">\n\t\t<x path=\"Bool\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>false</e></m>\n\t\t\t<m n=\"inspect\"/>\n\t\t</meta>\n\t</CAN_DESPERATE_ALPHASTRIKE>\n\t<DESPERATE_ALPHASTRIKE_CHANCE expr=\"0.5\" line=\"218\" static=\"1\">\n\t\t<x path=\"Float\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0.5</e></m>\n\t\t\t<m n=\"inspect\"><e>{display:\"range\",min:0,step:0.01,max:1}</e></m>\n\t\t</meta>\n\t</DESPERATE_ALPHASTRIKE_CHANCE>\n\t<B_VIABLE_PROBABILITY static=\"1\"><x path=\"Float\"/></B_VIABLE_PROBABILITY>\n\t<B_VIABLE_PROBABILITY_GET static=\"1\"><x path=\"Float\"/></B_VIABLE_PROBABILITY_GET>\n\t<B_VIABLE_HEURISTIC static=\"1\"><x path=\"Bool\"/></B_VIABLE_HEURISTIC>\n\t<B_MANUEVER_CHOICES expr=\"[]\" line=\"224\" static=\"1\">\n\t\t<c path=\"Array\"><c path=\"troshx.util.AIManueverChoice\"/></c>\n\t\t<meta><m n=\":value\"><e>[]</e></m></meta>\n\t</B_MANUEVER_CHOICES>\n\t<B_MANUEVER_CHOICE_PROBABILITIES expr=\"[]\" line=\"225\" static=\"1\">\n\t\t<c path=\"Array\"><x path=\"Float\"/></c>\n\t\t<meta><m n=\":value\"><e>[]</e></m></meta>\n\t</B_MANUEVER_CHOICE_PROBABILITIES>\n\t<B_MANUEVER_CHOICE_COUNT expr=\"0\" line=\"226\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>0</e></m></meta>\n\t</B_MANUEVER_CHOICE_COUNT>\n\t<B_COMBO_CANDIDATES expr=\"[]\" line=\"228\" static=\"1\">\n\t\t<c path=\"Array\"><x path=\"Int\"/></c>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>[]</e></m>\n\t\t\t<m n=\"enum\"><e>\"COMBO\"</e></m>\n\t\t</meta>\n\t</B_COMBO_CANDIDATES>\n\t<B_COMBO_CANDIDATE_MANUEVER expr=\"[]\" line=\"229\" static=\"1\">\n\t\t<c path=\"Array\"><c path=\"troshx.util.AIManueverChoice\"/></c>\n\t\t<meta><m n=\":value\"><e>[]</e></m></meta>\n\t</B_COMBO_CANDIDATE_MANUEVER>\n\t<B_COMBO_CANDIDATE_COUNT expr=\"0\" line=\"230\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>0</e></m></meta>\n\t</B_COMBO_CANDIDATE_COUNT>\n\t<BPROB_BASE get=\"inline\" set=\"null\" expr=\"1000\" line=\"232\" static=\"1\">\n\t\t<x path=\"Float\"/>\n\t\t<meta><m n=\":value\"><e>1000</e></m></meta>\n\t</BPROB_BASE>\n\t<DMG_AGGR_BASE get=\"inline\" set=\"null\" expr=\"10\" line=\"233\" static=\"1\">\n\t\t<x path=\"Float\"/>\n\t\t<meta><m n=\":value\"><e>10</e></m></meta>\n\t</DMG_AGGR_BASE>\n\t<IMPOSSIBLE_TN get=\"inline\" set=\"null\" expr=\"888\" line=\"234\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>888</e></m></meta>\n\t</IMPOSSIBLE_TN>\n\t<B_USE_ADVANTAGE public=\"1\" expr=\"false\" line=\"237\" static=\"1\">\n\t\t<x path=\"Bool\"/>\n\t\t<meta><m n=\":value\"><e>false</e></m></meta>\n\t</B_USE_ADVANTAGE>\n\t<getRegularAttackOrAdvantageMove public=\"1\" set=\"method\" line=\"249\" static=\"1\">\n\t\t<f a=\"availableCP:?roll:?againstRoll:?againstTN\" v=\":0:-1:1\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<c path=\"String\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{againstTN:1,againstRoll:-1,roll:0}</e></m>\n\t\t\t<m n=\"inspect\"><e>[{inspect:{min:0}},{inspect:{min:0}},{inspect:{min:-1}},{inspect:{min:1}}]</e></m>\n\t\t\t<m n=\"return\"><e>\"B_USE_ADVANTAGE\"</e></m>\n\t\t</meta>\n\t</getRegularAttackOrAdvantageMove>\n\t<getRegularAdvantageMove set=\"method\" line=\"271\" static=\"1\">\n\t\t<f a=\"availableCP:?roll:?againstRoll:?againstTN\" v=\":0:-1:1\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<c path=\"String\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{againstTN:1,againstRoll:-1,roll:0}</e></m>\n\t\t\t<m n=\"return\">\n\t\t\t\t<e>\"B_CANDIDATES\"</e>\n\t\t\t\t<e>\"B_CANDIDATE_COUNT\"</e>\n\t\t\t\t<e>\"ATTACK_AGGR\"</e>\n\t\t\t</m>\n\t\t\t<m n=\"inspect\"><e>[{inspect:{min:0}},{inspect:{min:0}},{inspect:{min:-1}},{inspect:{min:1}}]</e></m>\n\t\t</meta>\n\t</getRegularAdvantageMove>\n\t<mathMax get=\"inline\" set=\"null\" line=\"326\" static=\"1\"><f a=\"a:b\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></mathMax>\n\t<enforceDmgAggrIfFav set=\"method\" line=\"330\" static=\"1\"><f a=\"val\">\n\t<x path=\"Float\"/>\n\t<x path=\"Float\"/>\n</f></enforceDmgAggrIfFav>\n\t<ATTACK_AGGR expr=\"0\" line=\"335\" static=\"1\">\n\t\t<x path=\"Float\"/>\n\t\t<meta><m n=\":value\"><e>0</e></m></meta>\n\t</ATTACK_AGGR>\n\t<getRegularAttack set=\"method\" line=\"346\" static=\"1\">\n\t\t<f a=\"availableCP:?roll:?againstRoll:?againstTN\" v=\":0:-1:1\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<c path=\"String\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{againstTN:1,againstRoll:-1,roll:0}</e></m>\n\t\t\t<m n=\"return\">\n\t\t\t\t<e>\"B_CANDIDATES\"</e>\n\t\t\t\t<e>\"B_CANDIDATE_COUNT\"</e>\n\t\t\t\t<e>\"ATTACK_AGGR\"</e>\n\t\t\t</m>\n\t\t\t<m n=\"inspect\"><e>[{inspect:{min:0}},{inspect:{min:0}},{inspect:{min:-1}},{inspect:{min:1}}]</e></m>\n\t\t</meta>\n\t</getRegularAttack>\n\t<getRegularDefense public=\"1\" set=\"method\" line=\"451\" static=\"1\">\n\t\t<f a=\"availableCP:?roll:?enforceMustRegainInitiative\" v=\":0:false\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<c path=\"String\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{enforceMustRegainInitiative:false,roll:0}</e></m>\n\t\t\t<m n=\"return\">\n\t\t\t\t<e>\"B_CANDIDATES\"</e>\n\t\t\t\t<e>\"B_CANDIDATE_COUNT\"</e>\n\t\t\t</m>\n\t\t\t<m n=\"inspect\"><e>[{inspect:{min:0}},{inspect:{min:0}}]</e></m>\n\t\t</meta>\n\t</getRegularDefense>\n\t<getATNOfManuever set=\"method\" line=\"514\" static=\"1\"><f a=\"manuever\">\n\t<c path=\"String\"/>\n\t<x path=\"Int\"/>\n</f></getATNOfManuever>\n\t<isFleeingManuever get=\"inline\" set=\"null\" line=\"535\" static=\"1\"><f a=\"manueverName\">\n\t<c path=\"String\"/>\n\t<x path=\"Bool\"/>\n</f></isFleeingManuever>\n\t<getDTNOfManuever set=\"method\" line=\"539\" static=\"1\"><f a=\"manuever\">\n\t<c path=\"String\"/>\n\t<x path=\"Int\"/>\n</f></getDTNOfManuever>\n\t<getFollowupAtkManuever set=\"method\" line=\"563\" static=\"1\">\n\t\t<f a=\"favorable:lastManuever:availableCPWithBonus:againstCP:?customThreshold\" v=\"::::0\">\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<c path=\"troshx.util.AIManueverChoice\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{customThreshold:0}</e></m></meta>\n\t</getFollowupAtkManuever>\n\t<getTargetZoneAverageAVOffset public=\"1\" set=\"method\" line=\"572\" static=\"1\"><f a=\"tarZone:weaponName\">\n\t<x path=\"Int\"/>\n\t<c path=\"String\"/>\n\t<x path=\"Int\"/>\n</f></getTargetZoneAverageAVOffset>\n\t<getRegularTargetZone public=\"1\" set=\"method\" line=\"577\" static=\"1\"><f a=\"manuever:atn:cp\">\n\t<c path=\"String\"/>\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></getRegularTargetZone>\n\t<MANUEVER_CHOICE expr=\"&apos;???&apos;\" line=\"610\" static=\"1\">\n\t\t<c path=\"troshx.util.AIManueverChoice\"/>\n\t\t<meta><m n=\":value\"><e>'???'</e></m></meta>\n\t</MANUEVER_CHOICE>\n\t<MANUEVER_CHOICE_1 expr=\"&apos;???&apos;\" line=\"611\" static=\"1\">\n\t\t<c path=\"troshx.util.AIManueverChoice\"/>\n\t\t<meta><m n=\":value\"><e>'???'</e></m></meta>\n\t</MANUEVER_CHOICE_1>\n\t<MANUEVER_CHOICE_SET expr=\"&apos;???&apos;\" line=\"612\" static=\"1\">\n\t\t<c path=\"troshx.util.AIManueverChoice\"/>\n\t\t<meta><m n=\":value\"><e>'???'</e></m></meta>\n\t</MANUEVER_CHOICE_SET>\n\t<MANUEVER_COMBO_SET expr=\"0\" line=\"613\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0</e></m>\n\t\t\t<m n=\"enum\"><e>\"COMBO\"</e></m>\n\t\t</meta>\n\t</MANUEVER_COMBO_SET>\n\t<checkCostViability set=\"method\" line=\"616\" static=\"1\">\n\t\t<f a=\"availableCP:tn:threshold:againstRoll:?againstTN:?useAllCP\" v=\"::::1:false\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{useAllCP:false,againstTN:1}</e></m>\n\t\t\t<m n=\"return\"><e>\"B_VIABLE_PROBABILITY\"</e></m>\n\t\t</meta>\n\t</checkCostViability>\n\t<checkCostViabilityWithBs set=\"method\" line=\"631\" static=\"1\">\n\t\t<f a=\"availableCP:tn:threshold:againstRoll:?againstTN:?useAllCP:?bs\" v=\"::::1:false:1\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{bs:1,useAllCP:false,againstTN:1}</e></m></meta>\n\t</checkCostViabilityWithBs>\n\t<precisionPerc get=\"inline\" set=\"null\" line=\"639\" static=\"1\"><f a=\"val\">\n\t<x path=\"Float\"/>\n\t<x path=\"Float\"/>\n</f></precisionPerc>\n\t<checkCostViabilityBorderline set=\"method\" line=\"644\" static=\"1\">\n\t\t<f a=\"availableCP:tn:threshold:againstRoll:?againstTN:?useAllCP\" v=\"::::1:false\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{useAllCP:false,againstTN:1}</e></m>\n\t\t\t<m n=\"return\"><e>\"B_VIABLE_PROBABILITY\"</e></m>\n\t\t</meta>\n\t</checkCostViabilityBorderline>\n\t<checkCostAntiFavorability set=\"method\" line=\"667\" static=\"1\">\n\t\t<f a=\"availableCP:tn:threshold:againstCP:?againstTN:?useAllCP:?offset:?requiredBS\" v=\"::::1:false:0:1\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{requiredBS:1,offset:0,useAllCP:false,againstTN:1}</e></m>\n\t\t\t<m n=\"return\"><e>\"B_VIABLE_PROBABILITY_GET\"</e></m>\n\t\t</meta>\n\t</checkCostAntiFavorability>\n\t<checkCostAntiBorderline set=\"method\" line=\"706\" static=\"1\">\n\t\t<f a=\"availableCP:tn:threshold:againstCP:?againstTN:?useAllCP:?offset\" v=\"::::1:false:0\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{offset:0,useAllCP:false,againstTN:1}</e></m>\n\t\t\t<m n=\"return\"><e>\"B_VIABLE_PROBABILITY_GET\"</e></m>\n\t\t</meta>\n\t</checkCostAntiBorderline>\n\t<getCostOfAvail get=\"inline\" set=\"null\" line=\"740\" static=\"1\"><f a=\"avail\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></getCostOfAvail>\n\t<getTheSuitableAttack set=\"method\" line=\"744\" static=\"1\">\n\t\t<f a=\"manuever:tn:tarZone:threshold:availableCP:?againstRoll:?againstTN:?favorable:?useAllCP\" v=\":::::0:1:true:false\">\n\t\t\t<c path=\"String\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{useAllCP:false,favorable:true,againstTN:1,againstRoll:0}</e></m></meta>\n\t</getTheSuitableAttack>\n\t<getTheSuitableDefense set=\"method\" line=\"754\" static=\"1\">\n\t\t<f a=\"manuever:tn:threshold:availableCP:?againstRoll:?againstTN:?favorable:?useAllCP\" v=\"::::0:1:true:false\">\n\t\t\t<c path=\"String\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{useAllCP:false,favorable:true,againstTN:1,againstRoll:0}</e></m></meta>\n\t</getTheSuitableDefense>\n\t<getTheForcefulInitiativeAttack set=\"method\" line=\"763\" static=\"1\">\n\t\t<f a=\"manuever:tn:tarZone:threshold:availableCP:?againstCP:?againstTN:?favorable:?useAllCP:?offset\" v=\":::::0:1:true:false:0\">\n\t\t\t<c path=\"String\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{offset:0,useAllCP:false,favorable:true,againstTN:1,againstCP:0}</e></m></meta>\n\t</getTheForcefulInitiativeAttack>\n\t<getASuitableAttack public=\"1\" set=\"method\" line=\"774\" static=\"1\">\n\t\t<f a=\"threshold:availableCP:?againstRoll:?againstTN:?favorable:?useAllCP\" v=\"::0:1:true:false\">\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{useAllCP:false,favorable:true,againstTN:1,againstRoll:0}</e></m>\n\t\t\t<m n=\"return\">\n\t\t\t\t<e>\"MANUEVER_CHOICE\"</e>\n\t\t\t\t<e>\"B_VIABLE_PROBABILITY\"</e>\n\t\t\t</m>\n\t\t\t<m n=\"inspect\"><e>[{inspect:{min:0,step:0.01,max:1,display:\"range\"}},{inspect:{min:0}},{inspect:{min:0}},{inspect:{min:1}}]</e></m>\n\t\t</meta>\n\t</getASuitableAttack>\n\t<getAForcefulInitiativeAttack public=\"1\" set=\"method\" line=\"792\" static=\"1\">\n\t\t<f a=\"threshold:availableCP:?againstCP:?againstTN:?favorable:?useAllCP:?offset\" v=\"::0:1:true:false:0\">\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{offset:0,useAllCP:false,favorable:true,againstTN:1,againstCP:0}</e></m>\n\t\t\t<m n=\"return\">\n\t\t\t\t<e>\"MANUEVER_CHOICE\"</e>\n\t\t\t\t<e>\"B_VIABLE_PROBABILITY_GET\"</e>\n\t\t\t</m>\n\t\t\t<m n=\"inspect\"><e>[{inspect:{min:0,step:0.01,max:1,display:\"range\"}},{inspect:{min:0}},{inspect:{min:0}},{inspect:{min:1}}]</e></m>\n\t\t</meta>\n\t</getAForcefulInitiativeAttack>\n\t<getASuitableDefense public=\"1\" set=\"method\" line=\"812\" static=\"1\">\n\t\t<f a=\"threshold:availableCP:?againstRoll:?againstTN:?mustRegainInitiative:?favorable:?useAllCP\" v=\"::0:1:false:true:false\">\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{useAllCP:false,favorable:true,mustRegainInitiative:false,againstTN:1,againstRoll:0}</e></m>\n\t\t\t<m n=\"return\">\n\t\t\t\t<e>\"MANUEVER_CHOICE\"</e>\n\t\t\t\t<e>\"B_VIABLE_PROBABILITY\"</e>\n\t\t\t</m>\n\t\t\t<m n=\"inspect\"><e>[{inspect:{min:0,step:0.01,max:1,display:\"range\"}},{inspect:{min:0}},{inspect:{min:0}},{inspect:{min:1}}]</e></m>\n\t\t</meta>\n\t</getASuitableDefense>\n\t<FLAG_GET_CHEAPEST public=\"1\" get=\"inline\" set=\"null\" expr=\"1\" line=\"823\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>1</e></m></meta>\n\t</FLAG_GET_CHEAPEST>\n\t<FLAG_USE_ALL_CP public=\"1\" get=\"inline\" set=\"null\" expr=\"2\" line=\"824\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>2</e></m></meta>\n\t</FLAG_USE_ALL_CP>\n\t<FLAG_BORDERLINE_DEF_SAFETY public=\"1\" get=\"inline\" set=\"null\" expr=\"4\" line=\"825\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>4</e></m></meta>\n\t</FLAG_BORDERLINE_DEF_SAFETY>\n\t<FLEE_TN public=\"1\" get=\"inline\" set=\"null\" expr=\"4\" line=\"827\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>4</e></m></meta>\n\t</FLEE_TN>\n\t<getFavorableAttack public=\"1\" get=\"inline\" set=\"null\" line=\"831\" static=\"1\">\n\t\t<f a=\"availableCP:?againstRoll:?againstTN:?heuristic:?flags:?customThreshold\" v=\":0:1:true:0:0\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{customThreshold:0,flags:0,heuristic:true,againstTN:1,againstRoll:0}</e></m>\n\t\t\t<m n=\"inspect\"><e>[{inspect:{min:0}},{inspect:{min:0}},{inspect:{min:1}},{inspect:null},{inspect:null,bitmask:\"FLAG\"},{inspect:{min:0,display:\"range\",step:0.01,max:1}}]</e></m>\n\t\t\t<m n=\"return\">\n\t\t\t\t<e>\"B_VIABLE_PROBABILITY_GET\"</e>\n\t\t\t\t<e>\"MANUEVER_CHOICE\"</e>\n\t\t\t\t<e>\"B_VIABLE_HEURISTIC\"</e>\n\t\t\t</m>\n\t\t</meta>\n\t</getFavorableAttack>\n\t<getBorderlineAttack public=\"1\" set=\"method\" line=\"839\" static=\"1\">\n\t\t<f a=\"availableCP:?againstRoll:?againstTN:?heuristic:?flags:?customThreshold\" v=\":0:1:true:0:0\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{customThreshold:0,flags:0,heuristic:true,againstTN:1,againstRoll:0}</e></m>\n\t\t\t<m n=\"inspect\"><e>[{inspect:{min:0}},{inspect:{min:0}},{inspect:{min:1}},{inspect:null},{inspect:null,bitmask:\"FLAG\"},{inspect:{min:0,display:\"range\",step:0.01,max:1}}]</e></m>\n\t\t\t<m n=\"return\">\n\t\t\t\t<e>\"B_VIABLE_PROBABILITY_GET\"</e>\n\t\t\t\t<e>\"MANUEVER_CHOICE\"</e>\n\t\t\t\t<e>\"B_VIABLE_HEURISTIC\"</e>\n\t\t\t</m>\n\t\t</meta>\n\t</getBorderlineAttack>\n\t<getFBAttack set=\"method\" line=\"844\" static=\"1\">\n\t\t<f a=\"favorable:availableCP:?againstRoll:?againstTN:?heuristic:?flags:?customThreshold\" v=\"::0:1:true:0:0\">\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{customThreshold:0,flags:0,heuristic:true,againstTN:1,againstRoll:0}</e></m></meta>\n\t</getFBAttack>\n\t<getFBDefense set=\"method\" line=\"966\" static=\"1\">\n\t\t<f a=\"favorable:availableCP:?againstRoll:?againstTN:?heuristic:?flags:?customThreshold\" v=\"::0:1:true:0:0\">\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{customThreshold:0,flags:0,heuristic:true,againstTN:1,againstRoll:0}</e></m></meta>\n\t</getFBDefense>\n\t<getFavorableDefense public=\"1\" get=\"inline\" set=\"null\" line=\"1105\" static=\"1\">\n\t\t<f a=\"availableCP:?againstRoll:?againstTN:?heuristic:?flags\" v=\":0:1:true:0\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{flags:0,heuristic:true,againstTN:1,againstRoll:0}</e></m>\n\t\t\t<m n=\"return\">\n\t\t\t\t<e>\"B_VIABLE_PROBABILITY_GET\"</e>\n\t\t\t\t<e>\"MANUEVER_CHOICE\"</e>\n\t\t\t\t<e>\"B_VIABLE_HEURISTIC\"</e>\n\t\t\t</m>\n\t\t</meta>\n\t</getFavorableDefense>\n\t<getBorderlineDefense public=\"1\" get=\"inline\" set=\"null\" line=\"1111\" static=\"1\">\n\t\t<f a=\"availableCP:?againstRoll:?againstTN:?heuristic:?flags:?customThreshold\" v=\":0:1:true:0:0\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{customThreshold:0,flags:0,heuristic:true,againstTN:1,againstRoll:0}</e></m>\n\t\t\t<m n=\"return\">\n\t\t\t\t<e>\"B_VIABLE_PROBABILITY_GET\"</e>\n\t\t\t\t<e>\"MANUEVER_CHOICE\"</e>\n\t\t\t\t<e>\"B_VIABLE_HEURISTIC\"</e>\n\t\t\t</m>\n\t\t\t<m n=\"inspect\"><e>[{inspect:{min:0}},{inspect:{min:0}},{inspect:{min:1}},{inspect:null},{inspect:null,bitmask:\"FLAG\"},{inspect:{min:0,display:\"range\",step:0.01,max:1}}]</e></m>\n\t\t</meta>\n\t</getBorderlineDefense>\n\t<getFleeOrDefend set=\"method\" line=\"1116\" static=\"1\">\n\t\t<f a=\"favorable:availableCP:?againstRoll:?againstTN:?heuristic:?flags:?customThreshold:?secondExchange\" v=\"::0:1:true:0:0:false\">\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{secondExchange:false,customThreshold:0,flags:0,heuristic:true,againstTN:1,againstRoll:0}</e></m></meta>\n\t</getFleeOrDefend>\n\t<minimalDefenseFirst public=\"1\" set=\"method\" line=\"1128\" static=\"1\">\n\t\t<f a=\"availableCP:?againstRoll:?againstTN:?enemyCPInReserve\" v=\":0:1:0\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{enemyCPInReserve:0,againstTN:1,againstRoll:0}</e></m></meta>\n\t</minimalDefenseFirst>\n\t<minimalDefenseOnly get=\"inline\" set=\"null\" line=\"1140\" static=\"1\">\n\t\t<f a=\"availableCP:?againstRoll:?againstTN:?flags\" v=\":0:1:0\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{flags:0,againstTN:1,againstRoll:0}</e></m></meta>\n\t</minimalDefenseOnly>\n\t<lastDitchFleeOrDefend set=\"method\" line=\"1146\" static=\"1\">\n\t\t<f a=\"availableCP:threatManuever:?secondExchange:?enemyCPInReserve\" v=\"::false:0\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<c path=\"troshx.util.AIManueverChoice\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{enemyCPInReserve:0,secondExchange:false}</e></m></meta>\n\t</lastDitchFleeOrDefend>\n\t<weightedChoiceBetween set=\"method\" line=\"1321\" static=\"1\"><f a=\"trueConditionProbability:falseConditionProbability\">\n\t<x path=\"Float\"/>\n\t<x path=\"Float\"/>\n\t<x path=\"Bool\"/>\n</f></weightedChoiceBetween>\n\t<weightedChoiceBetween2 set=\"method\" line=\"1326\" static=\"1\"><f a=\"trueConditionProbability:falseConditionProbability:maxMarginOfDifference\">\n\t<x path=\"Float\"/>\n\t<x path=\"Float\"/>\n\t<x path=\"Float\"/>\n\t<x path=\"Bool\"/>\n</f></weightedChoiceBetween2>\n\t<absDiffF get=\"inline\" set=\"null\" line=\"1330\" static=\"1\"><f a=\"val:val2\">\n\t<x path=\"Float\"/>\n\t<x path=\"Float\"/>\n\t<x path=\"Float\"/>\n</f></absDiffF>\n\t<getDesperateFlee set=\"method\" line=\"1334\" static=\"1\"><f a=\"availableCP:secondExchange\">\n\t<x path=\"Int\"/>\n\t<x path=\"Bool\"/>\n\t<x path=\"Bool\"/>\n</f></getDesperateFlee>\n\t<getFlee set=\"method\" line=\"1344\" static=\"1\">\n\t\t<f a=\"favorable:availableCP:?againstRoll:?againstTN:?heuristic:?flags:?customThreshold:?secondExchange\" v=\"::0:1:true:0:0:false\">\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{secondExchange:false,customThreshold:0,flags:0,heuristic:true,againstTN:1,againstRoll:0}</e></m></meta>\n\t</getFlee>\n\t<getCPMaxForFleeing get=\"inline\" set=\"null\" line=\"1368\" static=\"1\"><f a=\"availableCP:secondExchange\">\n\t<x path=\"Int\"/>\n\t<x path=\"Bool\"/>\n\t<x path=\"Int\"/>\n</f></getCPMaxForFleeing>\n\t<tryBestPossibleDefenseBoliao set=\"method\" line=\"1374\" static=\"1\"><f a=\"cp:cp2:threatManuever:secondExchange\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n\t<c path=\"troshx.util.AIManueverChoice\"/>\n\t<x path=\"Bool\"/>\n\t<x path=\"Bool\"/>\n</f></tryBestPossibleDefenseBoliao>\n\t<tryBestPossibleAttackBoliao set=\"method\" line=\"1381\" static=\"1\"><f a=\"cp:cp2:threatManuever:secondExchange\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n\t<c path=\"troshx.util.AIManueverChoice\"/>\n\t<x path=\"Bool\"/>\n\t<x path=\"Bool\"/>\n</f></tryBestPossibleAttackBoliao>\n\t<MOCK_RETURN_ATTACK expr=\"&apos;???&apos;\" line=\"1399\" static=\"1\">\n\t\t<c path=\"troshx.util.AIManueverChoice\"/>\n\t\t<meta><m n=\":value\"><e>'???'</e></m></meta>\n\t</MOCK_RETURN_ATTACK>\n\t<tryBestPossibleAttackOrDefBoliao set=\"method\" line=\"1400\" static=\"1\"><f a=\"cp:cp2:threatManuever:secondExchange\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n\t<c path=\"troshx.util.AIManueverChoice\"/>\n\t<x path=\"Bool\"/>\n\t<x path=\"Bool\"/>\n</f></tryBestPossibleAttackOrDefBoliao>\n\t<tryBestPossibleDefWithInitiativeBoliao get=\"inline\" set=\"null\" line=\"1422\" static=\"1\"><f a=\"cp:cp2:threatManuever:secondExchange\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n\t<c path=\"troshx.util.AIManueverChoice\"/>\n\t<x path=\"Bool\"/>\n\t<x path=\"Bool\"/>\n</f></tryBestPossibleDefWithInitiativeBoliao>\n\t<addPossibleRegularManueverChoice get=\"inline\" set=\"null\" line=\"1438\" static=\"1\"><f a=\"index\">\n\t<x path=\"Int\"/>\n\t<x path=\"Void\"/>\n</f></addPossibleRegularManueverChoice>\n\t<getAdvantageManuever set=\"method\" line=\"1443\" static=\"1\">\n\t\t<f a=\"manueverName:favorable:availableCP:?againstRoll:?againstTN:?flags:?customThreshold:?preferedRS:?defensive:?alwaysUseOffhand\" v=\":::0:1:0:0:1:false:false\">\n\t\t\t<c path=\"String\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{alwaysUseOffhand:false,defensive:false,preferedRS:1,customThreshold:0,flags:0,againstTN:1,againstRoll:0}</e></m></meta>\n\t</getAdvantageManuever>\n\t<getBlockOpenAndStrike public=\"1\" set=\"method\" line=\"1472\" static=\"1\">\n\t\t<f a=\"favorable:availableCP:?againstRoll:?againstTN:?flags:?customThreshold:?preferedRS\" v=\"::0:1:0:0:1\">\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{preferedRS:1,customThreshold:0,flags:0,againstTN:1,againstRoll:0}</e></m>\n\t\t\t<m n=\"return\">\n\t\t\t\t<e>\"B_VIABLE_PROBABILITY_GET\"</e>\n\t\t\t\t<e>\"MANUEVER_CHOICE\"</e>\n\t\t\t</m>\n\t\t</meta>\n\t</getBlockOpenAndStrike>\n\t<getRota public=\"1\" get=\"inline\" set=\"null\" line=\"1477\" static=\"1\">\n\t\t<f a=\"favorable:availableCP:againstRoll:againstTN:?flags:?customThreshold:?preferedRS\" v=\"::::0:0:1\">\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{preferedRS:1,customThreshold:0,flags:0}</e></m>\n\t\t\t<m n=\"return\">\n\t\t\t\t<e>\"B_VIABLE_PROBABILITY_GET\"</e>\n\t\t\t\t<e>\"MANUEVER_CHOICE\"</e>\n\t\t\t</m>\n\t\t</meta>\n\t</getRota>\n\t<getCounter public=\"1\" get=\"inline\" set=\"null\" line=\"1482\" static=\"1\">\n\t\t<f a=\"favorable:availableCP:againstRoll:againstTN:?flags:?customThreshold:?preferedRS\" v=\"::::0:0:1\">\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{preferedRS:1,customThreshold:0,flags:0}</e></m>\n\t\t\t<m n=\"return\">\n\t\t\t\t<e>\"B_VIABLE_PROBABILITY_GET\"</e>\n\t\t\t\t<e>\"MANUEVER_CHOICE\"</e>\n\t\t\t</m>\n\t\t</meta>\n\t</getCounter>\n\t<getExpulsion public=\"1\" get=\"inline\" set=\"null\" line=\"1487\" static=\"1\">\n\t\t<f a=\"favorable:availableCP:againstRoll:againstTN:?flags:?customThreshold:?preferedRS\" v=\"::::0:0:1\">\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{preferedRS:1,customThreshold:0,flags:0}</e></m>\n\t\t\t<m n=\"return\">\n\t\t\t\t<e>\"B_VIABLE_PROBABILITY_GET\"</e>\n\t\t\t\t<e>\"MANUEVER_CHOICE\"</e>\n\t\t\t</m>\n\t\t</meta>\n\t</getExpulsion>\n\t<MAX_COUNTERING_AV get=\"inline\" set=\"null\" expr=\"8\" line=\"1492\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>8</e></m></meta>\n\t</MAX_COUNTERING_AV>\n\t<DEF_AGGR expr=\"0\" line=\"1495\" static=\"1\">\n\t\t<x path=\"Float\"/>\n\t\t<meta><m n=\":value\"><e>0</e></m></meta>\n\t</DEF_AGGR>\n\t<getSpecialDefWithReturnAttack public=\"1\" set=\"method\" line=\"1499\" static=\"1\">\n\t\t<f a=\"availableCP:againstCP:againstRoll:againstTN:?customThreshold:?secondExchange\" v=\"::::0:false\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{secondExchange:false,customThreshold:0}</e></m>\n\t\t\t<m n=\"return\">\n\t\t\t\t<e>\"B_VIABLE_PROBABILITY_GET\"</e>\n\t\t\t\t<e>\"MANUEVER_CHOICE\"</e>\n\t\t\t\t<e>\"DEF_AGGR\"</e>\n\t\t\t\t<e>\"B_MANUEVER_CHOICES\"</e>\n\t\t\t\t<e>\"B_MANUEVER_CHOICE_COUNT\"</e>\n\t\t\t</m>\n\t\t\t<m n=\"inspect\"><e>[{inspect:{min:0}},{inspect:{min:0}},{inspect:{min:0}},{inspect:{min:1}},{inspect:{min:0,display:\"range\",step:0.01,max:1}}]</e></m>\n\t\t</meta>\n\t</getSpecialDefWithReturnAttack>\n\t<getAverageOpponentCounterAV set=\"method\" line=\"1642\" static=\"1\"><f a=\"\"><x path=\"Int\"/></f></getAverageOpponentCounterAV>\n\t<maxI get=\"inline\" set=\"null\" line=\"1649\" static=\"1\"><f a=\"val:val2\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></maxI>\n\t<getDisarm public=\"1\" set=\"method\" line=\"1657\" static=\"1\">\n\t\t<f a=\"favorable:availableCP:?againstRoll:?againstTN:?flags:?customThreshold:?preferedRS:?defensive:?disarmOffhand\" v=\"::0:1:0:0:1:false:false\">\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{disarmOffhand:false,defensive:false,preferedRS:1,customThreshold:0,flags:0,againstTN:1,againstRoll:0}</e></m>\n\t\t\t<m n=\"return\">\n\t\t\t\t<e>\"B_VIABLE_PROBABILITY_GET\"</e>\n\t\t\t\t<e>\"MANUEVER_CHOICE\"</e>\n\t\t\t</m>\n\t\t</meta>\n\t</getDisarm>\n\t<getHook public=\"1\" get=\"inline\" set=\"null\" line=\"1663\" static=\"1\">\n\t\t<f a=\"favorable:availableCP:?againstRoll:?againstTN:?flags:?customThreshold:?preferedRS\" v=\"::0:1:0:0:1\">\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{preferedRS:1,customThreshold:0,flags:0,againstTN:1,againstRoll:0}</e></m>\n\t\t\t<m n=\"return\">\n\t\t\t\t<e>\"B_VIABLE_PROBABILITY_GET\"</e>\n\t\t\t\t<e>\"MANUEVER_CHOICE\"</e>\n\t\t\t</m>\n\t\t</meta>\n\t</getHook>\n\t<getBindStrike public=\"1\" get=\"inline\" set=\"null\" line=\"1668\" static=\"1\">\n\t\t<f a=\"favorable:availableCP:againstCP:?againstRoll:?againstTN:?flags:?customThreshold:?preferedRS\" v=\":::0:1:0:0:1\">\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{preferedRS:1,customThreshold:0,flags:0,againstTN:1,againstRoll:0}</e></m>\n\t\t\t<m n=\"return\">\n\t\t\t\t<e>\"B_VIABLE_PROBABILITY_GET\"</e>\n\t\t\t\t<e>\"MANUEVER_CHOICE\"</e>\n\t\t\t</m>\n\t\t</meta>\n\t</getBindStrike>\n\t<getBeat public=\"1\" set=\"method\" line=\"1673\" static=\"1\">\n\t\t<f a=\"favorable:availableCP:?againstRoll:?againstTN:?flags:?customThreshold:?preferedRS:?preferTargetMaster\" v=\"::0:1:0:0:1:0\">\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{preferTargetMaster:0,preferedRS:1,customThreshold:0,flags:0,againstTN:1,againstRoll:0}</e></m>\n\t\t\t<m n=\"return\">\n\t\t\t\t<e>\"B_VIABLE_PROBABILITY_GET\"</e>\n\t\t\t\t<e>\"MANUEVER_CHOICE\"</e>\n\t\t\t</m>\n\t\t</meta>\n\t</getBeat>\n\t<getAdvantageGainCPOffensiveMove public=\"1\" set=\"method\" line=\"1690\" static=\"1\">\n\t\t<f a=\"favorable:availableCP:?againstRoll:?againstTN:?flags:?customThreshold:?preferedRS:?preferTargetMaster\" v=\"::0:1:0:0:1:0\">\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{preferTargetMaster:0,preferedRS:1,customThreshold:0,flags:0,againstTN:1,againstRoll:0}</e></m>\n\t\t\t<m n=\"return\">\n\t\t\t\t<e>\"B_VIABLE_PROBABILITY_GET\"</e>\n\t\t\t\t<e>\"MANUEVER_CHOICE\"</e>\n\t\t\t</m>\n\t\t</meta>\n\t</getAdvantageGainCPOffensiveMove>\n\t<getPredictedOpponentDTN public=\"1\" get=\"inline\" set=\"null\" line=\"1720\" static=\"1\">\n\t\t<f a=\"\"><x path=\"Int\"/></f>\n\t\t<meta><m n=\"inspect\"/></meta>\n\t</getPredictedOpponentDTN>\n\t<getPredictedOpponentATN public=\"1\" get=\"inline\" set=\"null\" line=\"1725\" static=\"1\">\n\t\t<f a=\"\"><x path=\"Int\"/></f>\n\t\t<meta><m n=\"inspect\"/></meta>\n\t</getPredictedOpponentATN>\n\t<fluctuateLower get=\"inline\" set=\"null\" line=\"1803\" static=\"1\"><f a=\"val:lowerBy\">\n\t<x path=\"Float\"/>\n\t<x path=\"Float\"/>\n\t<x path=\"Float\"/>\n</f></fluctuateLower>\n\t<getComboExchangeBudgetingWithInitiative set=\"method\" line=\"1812\" static=\"1\">\n\t\t<f a=\"combo:cp:cp2:?threatManuever\" v=\":::null\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<c path=\"troshx.util.AIManueverChoice\"/>\n\t\t\t<x path=\"haxe.ds.Vector\"><x path=\"Int\"/></x>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{threatManuever:null}</e></m>\n\t\t\t<m n=\"inspect\"><e>[{inspect:{display:\"selector\"},choices:\"COMBO\"},{inspect:{min:0}},{inspect:{min:0}}]</e></m>\n\t\t</meta>\n\t</getComboExchangeBudgetingWithInitiative>\n\t<tryFavoredElseBorderlineAttacks get=\"inline\" set=\"null\" line=\"1901\" static=\"1\"><f a=\"cp:cp2:dtn:heuristic:flags\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n\t<x path=\"Bool\"/>\n\t<x path=\"Int\"/>\n\t<x path=\"Bool\"/>\n</f></tryFavoredElseBorderlineAttacks>\n\t<getComboAction set=\"method\" line=\"1916\" static=\"1\">\n\t\t<f a=\"combo:cp:cp2:?threatManuever:?hasInitiative:?secondExchange\" v=\":::null:true:false\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<c path=\"troshx.util.AIManueverChoice\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{secondExchange:false,hasInitiative:true,threatManuever:null}</e></m></meta>\n\t</getComboAction>\n\t<getComboActionTest set=\"method\" line=\"2060\" static=\"1\">\n\t\t<f a=\"combo:cp:cp2:?threatManuever:?hasInitiative:?secondExchange\" v=\":::null:true:false\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<c path=\"troshx.util.AIManueverChoice\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{secondExchange:false,hasInitiative:true,threatManuever:null}</e></m>\n\t\t\t<m n=\"return\">\n\t\t\t\t<e>\"B_VIABLE_PROBABILITY_GET\"</e>\n\t\t\t\t<e>\"MANUEVER_CHOICE\"</e>\n\t\t\t</m>\n\t\t\t<m n=\"inspect\"><e>[{inspect:{display:\"selector\"},choices:\"COMBO\"},{inspect:{min:0}},{inspect:{min:0}}]</e></m>\n\t\t</meta>\n\t</getComboActionTest>\n\t<getCheapestBorderlineAtkCost set=\"method\" line=\"2067\" static=\"1\">\n\t\t<f a=\"cp:againstCP:dtn:?customThreshold\" v=\":::0\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Float\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{customThreshold:0}</e></m></meta>\n\t</getCheapestBorderlineAtkCost>\n\t<getCoupThreshold get=\"inline\" set=\"null\" line=\"2087\" static=\"1\"><f a=\"cp2\">\n\t<x path=\"Int\"/>\n\t<x path=\"Float\"/>\n</f></getCoupThreshold>\n\t<addPossibleComboManueverChoice get=\"inline\" set=\"null\" line=\"2093\" static=\"1\"><f a=\"index:theChoice\">\n\t<x path=\"Int\"/>\n\t<c path=\"troshx.util.AIManueverChoice\"/>\n\t<x path=\"Void\"/>\n</f></addPossibleComboManueverChoice>\n\t<BUDGET_SKIP get=\"inline\" set=\"null\" expr=\"-1\" line=\"2099\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>-1</e></m></meta>\n\t</BUDGET_SKIP>\n\t<MANUEVER_CHOICE_CONSIDER_MASTER expr=\"&apos;???&apos;\" line=\"2100\" static=\"1\">\n\t\t<c path=\"troshx.util.AIManueverChoice\"/>\n\t\t<meta><m n=\":value\"><e>'???'</e></m></meta>\n\t</MANUEVER_CHOICE_CONSIDER_MASTER>\n\t<setBestComboActionWithInitiativePlan set=\"method\" line=\"2112\" static=\"1\">\n\t\t<f a=\"cp:cp2:?threatManuever\" v=\"::null\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<c path=\"troshx.util.AIManueverChoice\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{threatManuever:null}</e></m></meta>\n\t</setBestComboActionWithInitiativePlan>\n\t<setBestComboActionWithInitiativePlanTest set=\"method\" line=\"2191\" static=\"1\">\n\t\t<f a=\"cp:cp2:?threatManuever\" v=\"::null\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<c path=\"troshx.util.AIManueverChoice\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>{threatManuever:null}</e></m>\n\t\t\t<m n=\"return\">\n\t\t\t\t<e>\"MANUEVER_COMBO_SET\"</e>\n\t\t\t\t<e>\"MANUEVER_CHOICE_SET\"</e>\n\t\t\t\t<e>\"B_COMBO_CANDIDATE_COUNT\"</e>\n\t\t\t\t<e>\"B_COMBO_CANDIDATES\"</e>\n\t\t\t</m>\n\t\t\t<m n=\"inspect\"><e>[{inspect:{min:0}},{inspect:{min:0}}]</e></m>\n\t\t</meta>\n\t</setBestComboActionWithInitiativePlanTest>\n\t<setBestComboActionWithoutInitiativePlan public=\"1\" set=\"method\" line=\"2211\" static=\"1\"><f a=\"cp:cp2:threatManuever\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n\t<c path=\"troshx.util.AIManueverChoice\"/>\n\t<x path=\"Bool\"/>\n</f></setBestComboActionWithoutInitiativePlan>\n\t<setBestComboActionWithoutInitiativePlanTest public=\"1\" set=\"method\" line=\"2259\" static=\"1\">\n\t\t<f a=\"cp:cp2:threatManuever\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<c path=\"troshx.util.AIManueverChoice\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t</f>\n\t\t<meta>\n\t\t\t<m n=\"return\">\n\t\t\t\t<e>\"MANUEVER_COMBO_SET\"</e>\n\t\t\t\t<e>\"MANUEVER_CHOICE_SET\"</e>\n\t\t\t\t<e>\"B_COMBO_CANDIDATE_COUNT\"</e>\n\t\t\t\t<e>\"B_COMBO_CANDIDATES\"</e>\n\t\t\t</m>\n\t\t\t<m n=\"inspect\"><e>[{inspect:{min:0}},{inspect:{min:0}}]</e></m>\n\t\t</meta>\n\t</setBestComboActionWithoutInitiativePlanTest>\n\t<opponents expr=\"[]\" line=\"20\">\n\t\t<c path=\"Array\"><c path=\"troshx.tros.ai.TROSAiBot\"/></c>\n\t\t<meta><m n=\":value\"><e>[]</e></m></meta>\n\t</opponents>\n\t<opponentLen expr=\"0\" line=\"21\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>0</e></m></meta>\n\t</opponentLen>\n\t<cpBudget expr=\"[]\" line=\"22\">\n\t\t<c path=\"Array\"><x path=\"Int\"/></c>\n\t\t<meta><m n=\":value\"><e>[]</e></m></meta>\n\t</cpBudget>\n\t<plannedCombos expr=\"[0,0,0,0]\" line=\"24\">\n\t\t<c path=\"Array\"><x path=\"Int\"/></c>\n\t\t<meta><m n=\":value\"><e>[0,0,0,0]</e></m></meta>\n\t</plannedCombos>\n\t<currentExchange expr=\"0\" line=\"26\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>0</e></m></meta>\n\t</currentExchange>\n\t<body public=\"1\">\n\t\t<c path=\"troshx.BodyChar\"/>\n\t\t<meta><m n=\"inject\"/></meta>\n\t</body>\n\t<cp public=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\"bind\"><e>\"_cp\"</e></m></meta>\n\t</cp>\n\t<perception public=\"1\" expr=\"4\" line=\"32\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>4</e></m>\n\t\t\t<m n=\"bind\"><e>\"_perception\"</e></m>\n\t\t</meta>\n\t</perception>\n\t<equipMasterhand public=\"1\">\n\t\t<c path=\"String\"/>\n\t\t<meta><m n=\"bind\"><e>\"_equipMasterhand\"</e></m></meta>\n\t</equipMasterhand>\n\t<equipOffhand public=\"1\">\n\t\t<c path=\"String\"/>\n\t\t<meta><m n=\"bind\"><e>\"_equipOffhand\"</e></m></meta>\n\t</equipOffhand>\n\t<mobility public=\"1\" expr=\"6\" line=\"35\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>6</e></m>\n\t\t\t<m n=\"bind\"><e>\"_mobility\"</e></m>\n\t\t</meta>\n\t</mobility>\n\t<id public=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\"bind\"><e>\"_id\"</e></m></meta>\n\t</id>\n\t<fight_initiative public=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\"bind\"><e>\"_fight_initiative\"</e></m></meta>\n\t</fight_initiative>\n\t<stance public=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\"bind\"><e>\"_fight_stance\"</e></m></meta>\n\t</stance>\n\t<manueverUsingHands public=\"1\" expr=\"0\" line=\"42\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\":value\"><e>0</e></m>\n\t\t\t<m n=\"bind\"><e>\"_manueverUsingHands\"</e></m>\n\t\t</meta>\n\t</manueverUsingHands>\n\t<handsUsedUp expr=\"0\" line=\"58\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>0</e></m></meta>\n\t</handsUsedUp>\n\t<decidedStance public=\"1\"><x path=\"Int\"/></decidedStance>\n\t<decidedOrientation public=\"1\"><x path=\"Int\"/></decidedOrientation>\n\t<decidedManuevers public=\"1\" expr=\"[&apos;???&apos;,&apos;???&apos;,&apos;???&apos;,&apos;???&apos;]\" line=\"62\">\n\t\t<c path=\"Array\"><c path=\"troshx.util.AIManueverChoice\"/></c>\n\t\t<meta><m n=\":value\"><e>['???','???','???','???']</e></m></meta>\n\t</decidedManuevers>\n\t<getDecidedManueverForSlot public=\"1\" set=\"method\" line=\"66\"><f a=\"slot\">\n\t<x path=\"Int\"/>\n\t<c path=\"String\"/>\n</f></getDecidedManueverForSlot>\n\t<getDecidedManueverCP public=\"1\" set=\"method\" line=\"69\"><f a=\"slot\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></getDecidedManueverCP>\n\t<getDecidedManueverTargetZone public=\"1\" set=\"method\" line=\"72\"><f a=\"slot\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></getDecidedManueverTargetZone>\n\t<getPredictedDTN set=\"method\" line=\"1729\"><f a=\"\"><x path=\"Int\"/></f></getPredictedDTN>\n\t<getPredictedATN set=\"method\" line=\"1749\"><f a=\"\"><x path=\"Int\"/></f></getPredictedATN>\n\t<getOffhandDTN get=\"inline\" set=\"null\" line=\"1778\"><f a=\"\"><x path=\"Int\"/></f></getOffhandDTN>\n\t<getShieldDTN get=\"inline\" set=\"null\" line=\"1783\"><f a=\"\"><x path=\"Int\"/></f></getShieldDTN>\n\t<getMasterDTN get=\"inline\" set=\"null\" line=\"1787\"><f a=\"\"><x path=\"Int\"/></f></getMasterDTN>\n\t<getHighestATNOrDTN set=\"method\" line=\"1793\"><f a=\"\"><x path=\"Int\"/></f></getHighestATNOrDTN>\n\t<getDTNBetterMargin get=\"inline\" set=\"null\" line=\"1799\"><f a=\"\"><x path=\"Int\"/></f></getDTNBetterMargin>\n\t<isDualWeilding get=\"inline\" set=\"null\" line=\"2082\"><f a=\"\"><x path=\"Bool\"/></f></isDualWeilding>\n\t<newExchange public=\"1\" set=\"method\" line=\"2280\">\n\t\t<f a=\"?newRound\" v=\"false\">\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Void\"/>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{newRound:false}</e></m></meta>\n\t</newExchange>\n\t<decideStance public=\"1\" set=\"method\" line=\"2298\"><f a=\"enemies:target:targetedBy\">\n\t<c path=\"Array\"><c path=\"troshx.tros.ai.TROSAiBot\"/></c>\n\t<c path=\"troshx.tros.ai.TROSAiBot\"/>\n\t<c path=\"Array\"><c path=\"troshx.tros.ai.TROSAiBot\"/></c>\n\t<x path=\"Void\"/>\n</f></decideStance>\n\t<decideOrientation public=\"1\" set=\"method\" line=\"2302\"><f a=\"enemies:target:targetedBy\">\n\t<c path=\"Array\"><c path=\"troshx.tros.ai.TROSAiBot\"/></c>\n\t<c path=\"troshx.tros.ai.TROSAiBot\"/>\n\t<c path=\"Array\"><c path=\"troshx.tros.ai.TROSAiBot\"/></c>\n\t<x path=\"Void\"/>\n</f></decideOrientation>\n\t<decideTarget public=\"1\" set=\"method\" line=\"2306\"><f a=\"enemies\">\n\t<c path=\"Array\"><c path=\"troshx.tros.ai.TROSAiBot\"/></c>\n\t<x path=\"Void\"/>\n</f></decideTarget>\n\t<preDeclareManuevers public=\"1\" set=\"method\" line=\"2313\"><f a=\"target:targetedBy\">\n\t<c path=\"troshx.tros.ai.TROSAiBot\"/>\n\t<c path=\"Array\"><c path=\"troshx.tros.ai.TROSAiBot\"/></c>\n\t<x path=\"Void\"/>\n</f></preDeclareManuevers>\n\t<getRemainingCPLeftIfUnpaid public=\"1\" set=\"method\" line=\"2341\"><f a=\"\"><x path=\"Int\"/></f></getRemainingCPLeftIfUnpaid>\n\t<getTotalThreatCPAgainst public=\"1\" set=\"method\" line=\"2350\"><f a=\"targetId\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></getTotalThreatCPAgainst>\n\t<declareManueverAgainstOpponent public=\"1\" set=\"method\" line=\"2379\"><f a=\"index\">\n\t<x path=\"Int\"/>\n\t<x path=\"Bool\"/>\n</f></declareManueverAgainstOpponent>\n\t<get_initiative set=\"method\" line=\"2459\"><f a=\"\"><x path=\"Bool\"/></f></get_initiative>\n\t<set_initiative set=\"method\" line=\"2464\"><f a=\"value\">\n\t<x path=\"Bool\"/>\n\t<x path=\"Bool\"/>\n</f></set_initiative>\n\t<initiative public=\"1\" get=\"accessor\" set=\"accessor\"><x path=\"Bool\"/></initiative>\n\t<new public=\"1\" set=\"method\" line=\"2272\"><f a=\"\"><x path=\"Void\"/></f></new>\n\t<meta>\n\t\t<m n=\":directlyUsed\"/>\n\t\t<m n=\":expose\"/>\n\t\t<m n=\":rtti\"/>\n\t</meta>\n</class>";

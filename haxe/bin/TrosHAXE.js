...
haxevx_vuex_examples_AppMutator.prototype = {
	testTypeDef: null
	,test: function() {
		var mypayload = { name : "rete"};
		haxevx_vuex_examples_AppMutator.doSomethingSpecial(mypayload);
		haxevx_vuex_examples_AppMutator.doSomething(3);
		haxevx_vuex_examples_AppMutator.moveTo({ x : 4, y : 2},null);
	}
	,__class__: haxevx_vuex_examples_AppMutator
};
...
haxevx_vuex_examples_Helpers.__rtti = "<class path=\"haxevx.vuex.examples.Helpers\" params=\"\" module=\"haxevx.vuex.examples.AppMutator\">\n\t<Move public=\"1\" get=\"inline\" set=\"null\" line=\"33\" static=\"1\">\n\t\t<f a=\"?x:?y:?context\" v=\"0:0:null\">\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<d/>\n\t\t\t<x path=\"Void\"/>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{ context : null, y : 0, x : 0 }</e></m></meta>\n\t</Move>\n\t<meta><m n=\":rtti\"/></meta>\n</class>";
haxevx_vuex_examples_AppMutator.__rtti = "<class path=\"haxevx.vuex.examples.AppMutator\" params=\"\">\n\t<doSomething public=\"1\" params=\"S:P\" set=\"method\" line=\"53\" static=\"1\">\n\t\t<f a=\"payload:?context\" v=\":null\">\n\t\t\t<c path=\"doSomething.P\"/>\n\t\t\t<d/>\n\t\t\t<f a=\":\">\n\t\t\t\t<c path=\"doSomething.S\"/>\n\t\t\t\t<c path=\"doSomething.P\"/>\n\t\t\t\t<x path=\"Void\"/>\n\t\t\t</f>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{ context : null }</e></m></meta>\n\t</doSomething>\n\t<moveTo public=\"1\" params=\"S:P\" set=\"method\" line=\"60\" static=\"1\">\n\t\t<f a=\"position:?context\" v=\":null\">\n\t\t\t<c path=\"moveTo.P\"/>\n\t\t\t<d/>\n\t\t\t<f a=\":\">\n\t\t\t\t<c path=\"moveTo.S\"/>\n\t\t\t\t<c path=\"moveTo.P\"/>\n\t\t\t\t<x path=\"Void\"/>\n\t\t\t</f>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{ context : null }</e></m></meta>\n\t</moveTo>\n\t<doSomethingSpecial public=\"1\" params=\"S:P\" set=\"method\" line=\"66\" static=\"1\">\n\t\t<f a=\"payload:?context\" v=\":null\">\n\t\t\t<c path=\"doSomethingSpecial.P\"/>\n\t\t\t<d/>\n\t\t\t<f a=\":\">\n\t\t\t\t<c path=\"doSomethingSpecial.S\"/>\n\t\t\t\t<c path=\"doSomethingSpecial.P\"/>\n\t\t\t\t<x path=\"Void\"/>\n\t\t\t</f>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{ context : null }</e></m></meta>\n\t</doSomethingSpecial>\n\t<testTypeDef public=\"1\"><t path=\"haxevx.vuex.examples.SomethingPayload\"/></testTypeDef>\n\t<test public=\"1\" set=\"method\" line=\"44\"><f a=\"\"><x path=\"Void\"/></f></test>\n\t<meta>\n\t\t<m n=\":directlyUsed\"/>\n\t\t<m n=\":rtti\"/>\n\t</meta>\n</class>";

...
troshx_tros_ai_TROSAiBot.checkCostAntiFavorability = function(availableCP,tn,threshold,againstCP,againstTN,useAllCP,offset) {
	...
	while(_g1 < _g) {
		var c = _g1++;
		accum = troshx_tros_ai_TROSAiBot.precisionPerc(troshx_util_TROSAI.getChanceToSucceedContest(againstCP,againstTN,c,tn,1,true));
		if(accum < threshold) {
			cpToUse = c;
			break;
		}
...
troshx_tros_ai_TROSAiBot.COMBOS_LEN_NO_INITAITIVE = 4;

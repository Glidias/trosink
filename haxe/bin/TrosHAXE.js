...
troshx_tros_ai_TROSAiBot.getComboAction = function(combo,cp,cp2,threatManuever,hasInitiative,secondExchange) {
	...
	case 1:
		return troshx_tros_ai_TROSAiBot.getFavorableAttack(cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),true,flags) || troshx_tros_ai_TROSAiBot.getAdvantageGainCPOffensiveMove(true,cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),flags) || troshx_tros_ai_TROSAiBot.getBorderlineAttack(cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),true,flags) || troshx_tros_ai_TROSAiBot.getAdvantageGainCPOffensiveMove(false,cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),flags);
	case 2:
		if(!secondExchange) return troshx_tros_ai_TROSAiBot.getAForcefulInitiativeAttack(troshx_tros_ai_TROSAiBot.P_THRESHOLD_FAVORABLE,cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),true,true,0); else return troshx_tros_ai_TROSAiBot.getFavorableAttack(cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),true,flags) || troshx_tros_ai_TROSAiBot.getAdvantageGainCPOffensiveMove(true,cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),flags) || troshx_tros_ai_TROSAiBot.getBorderlineAttack(cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),true,flags) || troshx_tros_ai_TROSAiBot.getAdvantageGainCPOffensiveMove(false,cp,cp2,troshx_tros_ai_TROSAiBot.CURRENT_OPPONENT.getPredictedDTN(),flags);
		break;
	case 3:
		if(!secondExchange) {
...
troshx_util_AIManueverChoice.__rtti = "<class path=\"troshx.util.AIManueverChoice\" params=\"\" module=\"troshx.util.TROSAI\">\n\t<TYPE_ATTACKING public=\"1\" get=\"inline\" set=\"null\" expr=\"2\" line=\"239\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>2</e></m></meta>\n\t</TYPE_ATTACKING>\n\t<TYPE_DEFENDING public=\"1\" get=\"inline\" set=\"null\" expr=\"1\" line=\"240\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>1</e></m></meta>\n\t</TYPE_DEFENDING>\n\t<TARGET_WEAPON public=\"1\" get=\"inline\" set=\"null\" expr=\"0\" line=\"242\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>0</e></m></meta>\n\t</TARGET_WEAPON>\n\t<TARGET_SHIELD public=\"1\" get=\"inline\" set=\"null\" expr=\"1\" line=\"243\" static=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\":value\"><e>1</e></m></meta>\n\t</TARGET_SHIELD>\n\t<manuever public=\"1\">\n\t\t<c path=\"String\"/>\n\t\t<meta><m n=\"inspect\"/></meta>\n\t</manuever>\n\t<manueverCP public=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\"inspect\"><e>{min:0}</e></m></meta>\n\t</manueverCP>\n\t<manueverTN public=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\"inspect\"><e>{min:0}</e></m></meta>\n\t</manueverTN>\n\t<targetZone public=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\"inspect\"><e>{min:0}</e></m></meta>\n\t</targetZone>\n\t<manueverType public=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\"inspect\"><e>{display:\"selector\"}</e></m>\n\t\t\t<m n=\"choices\"><e>\"TYPE\"</e></m>\n\t\t</meta>\n\t</manueverType>\n\t<offhand public=\"1\">\n\t\t<x path=\"Bool\"/>\n\t\t<meta><m n=\"inspect\"/></meta>\n\t</offhand>\n\t<againstID public=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\"inspect\"/></meta>\n\t</againstID>\n\t<cost public=\"1\">\n\t\t<x path=\"Int\"/>\n\t\t<meta><m n=\"inspect\"><e>{min:0}</e></m></meta>\n\t</cost>\n\t<getManueverCPSpent public=\"1\" get=\"inline\" set=\"null\" line=\"235\"><f a=\"\"><x path=\"Int\"/></f></getManueverCPSpent>\n\t<nothing public=\"1\" get=\"inline\" set=\"null\" line=\"250\"><f a=\"\"><x path=\"Void\"/></f></nothing>\n\t<copyTo public=\"1\" get=\"inline\" set=\"null\" line=\"259\">\n\t\t<f a=\"newChoice:?newAgainstID\" v=\":-1\">\n\t\t\t<c path=\"troshx.util.AIManueverChoice\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Void\"/>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{newAgainstID:-1}</e></m></meta>\n\t</copyTo>\n\t<setAttack public=\"1\" set=\"method\" line=\"270\">\n\t\t<f a=\"manuever:manueverCP:manueverTN:targetZone:cost:?offhand\" v=\":::::false\">\n\t\t\t<c path=\"String\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Void\"/>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{offhand:false}</e></m></meta>\n\t</setAttack>\n\t<setDefend public=\"1\" set=\"method\" line=\"280\">\n\t\t<f a=\"manuever:manueverCP:manueverTN:cost:?offhand\" v=\"::::false\">\n\t\t\t<c path=\"String\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Int\"/>\n\t\t\t<x path=\"Bool\"/>\n\t\t\t<x path=\"Void\"/>\n\t\t</f>\n\t\t<meta><m n=\":value\"><e>{offhand:false}</e></m></meta>\n\t</setDefend>\n\t<new public=\"1\" set=\"method\" line=\"245\"><f a=\"\"><x path=\"Void\"/></f></new>\n\t<meta>\n\t\t<m n=\":directlyUsed\"/>\n\t\t<m n=\":rtti\"/>\n\t\t<m n=\":expose\"/>\n\t</meta>\n</class>";
...
troshx_tros_ai_TROSAiBot.COMBOS_LEN_INITIATIVE = 8;

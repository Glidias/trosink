...
var troshx_sos_manuevers_Hook = function() {
	...
	this._types(2)._requisite(1)._attackTypes(3)._targetZoneMode(-1)._costs(1)._superior();
};
...
var troshx_sos_manuevers_MeleeShoot = function() {
	...
	this._types(2)._requisite(1)._attackTypes(2)._ranged();
};
		...
		if(tag == "swing" || tag == "part" || name == "enemyHandLeft" || name == "enemyHandRight") {
			if((event & 266240) != 0 || index != this.viewModel.focusedIndex) {
				...
				if(name == "enemyHandLeft" || name == "enemyHandRight") {
					if(!this.viewModel.advInteract1.disabled) {
...
troshx_sos_core_Manuever.ATTACK_TYPE_SHOOTING = 8;
...
troshx_sos_core_Manuever.TARGET_ZONE_OPPONENT = -1;

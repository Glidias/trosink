...
var troshx_sos_manuevers_WeaponThrow = function() {
	...
	this._types(2)._requisite(1)._attackTypes(2)._costs(1)._ranged();
};
...
var troshx_sos_vue_combat_CombatViewModel = function(boutModel) {
	...
	this.basicThrow = this.manueverRepo["throw"];
...
troshx_sos_vue_combat_CombatViewModel.prototype = {
	...
	,getBasicTargetingLabels: function() {
	...
	,getAdvancedManuevers: function(curPlayer,playerLeftItem,playerRightItem,curEnemy,enemyLeftItem,enemyRightItem) {
...
troshx_sos_vue_combat_components_DollView.prototype = $extend(haxevx_vuex_core_VComponent.prototype,{
	...
	,on_isDefBtnBlockVisible: function(val,oldVal) {
	...
	,on_isDefBtnParryVisible: function(val,oldVal) {

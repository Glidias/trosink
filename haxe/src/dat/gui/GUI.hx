...
import dat.controllers.TextAreaController;
import haxe.Json;
...
{	
	...
	/**
	 * Adds a textarea. Requires fork https://github.com/Glidias/dat.gui
	 * 
	 * @param object
	 * @param property
	 * @returns {TextAreaController} The new TextAreaController that was added.
	 */
	function addTextArea(object:Dynamic, property:String) : TextAreaController;
	 ...
	 */
	public var __controllers:Array<GUI>;

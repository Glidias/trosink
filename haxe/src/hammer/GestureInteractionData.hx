...
typedef GestureInteractionData = {
	...
	var pointers:Array<Dynamic>;				//Array with all pointers, including the ended pointers (touchend, mouseup).
	var changedPointers:Array<Dynamic>;		//Array with all new/moved/lost pointers.

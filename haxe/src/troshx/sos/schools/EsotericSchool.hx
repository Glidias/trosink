...
class EsotericSchoolBonuses extends SchoolBonuses {
	...
	@:ui({type:"SingleSelection", label:"Benefit(s)", labels:["Simplicity, Flowing Water", "Raging Flame", "Biting Wind", "Stoic Earth"], values:[SIMPLICITY|FLOWING_WATER, RAGING_FLAME, BITING_WIND, STOIC_EARTH] }) public var flags:Int;

...
import troshx.sos.vue.combat.ImageMapData;
 ...
 * @author Glidias
 */
class ZoneItemView extends VComponent<NoneT, ZoneItemViewProps>
{
	...
	var title:String;
	*/
	@:computed function get_item():LayoutItem {
		var d = this.mapData;
		return mapData.layoutItemList[index];
	}
	
	@:computed function get_x():Float {
		var d = this.mapData;
		var r = d.renderCount;
		var i:Int = this.index;
		return d.positionList[i].x*d.refWidth*d.scaleX;
	}
	
	@:computed function get_y():Float {
		var d = this.mapData;
		var r = d.renderCount;
		var i:Int = this.index;
		return d.positionList[i].y*d.refHeight*d.scaleY;
	}
	
	@:computed function get_width():Float {
		var d = this.mapData;
		var r = d.renderCount;
		var i:Int = this.index;
		return d.scaleList[i].x*d.refWidth*d.scaleX;
	}
	
	@:computed function get_height():Float {
		var d = this.mapData;
		var r = d.renderCount;
		var i:Int = this.index;
		return d.scaleList[i].y * d.refHeight * d.scaleY;
	}
	
	@:computed function get_title():String {
		var d = this.mapData;
		return d.titleList[index];
	}
	
	
}

typedef ShapeStyleProps = {
